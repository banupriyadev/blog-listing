...
if (empty($_SESSION['user'])) {
  ...
  redirect('login'); // Adjust the redirect path as necessary
...
$filename = '../public/adminn/'.$section.'.php';

if(!file_exists($filename)){
  
  $filename = "../public/adminn/404.php";
}
...
if($section == 'users'){
  ...
  require_once('../public/adminn/users-controller.php');
}
elseif($section == "categories"){
   require_once('../public/adminn/categories-controller.php');
}

elseif($section == "posts"){
  require_once('../public/adminn/posts-controller.php');
}
...
<header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
  <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="#">Pranaya Weddings</a>
    ...
    <div class="sidebar border border-right col-md-3 col-lg-2 p-0 bg-body-tertiary">
      <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
        <div class="offcanvas-header">
          <h5 class="offcanvas-title" id="sidebarMenuLabel">Pranaya Weddings</h5>
...
<script src="<?=ROOT?>/assets/bootstrap/bootstrap.min.js"></script>
